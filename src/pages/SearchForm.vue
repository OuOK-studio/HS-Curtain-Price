    ...
    <div class="flex flex-col gap-6 h-full p-4">
      ...
      <InputGroup>
        ...
        <template v-if="metadata">
          ...
          <InputNumber :invalid="errors.width" v-model="width" :min="metadata.width[0]" :max="metadata.width[1]"/>
      ...
      <InputGroup>
        ...
        <template v-if="metadata">
          ...
          <InputNumber :invalid="errors.height" v-model="height" :min="metadata.height[0]" :max="metadata.height[1]"/>
