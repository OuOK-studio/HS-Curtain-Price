...
declare global {
  ...
  const data: typeof import('../src/api/data')['data']
  ...
  const useMetadata: typeof import('../src/api/metadata')['useMetadata']
  ...
  const usePrice: typeof import('../src/api/price')['usePrice']
